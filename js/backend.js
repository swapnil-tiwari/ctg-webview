...
*/
    ...
    async function updateData_f()
    {
      ...
      try
      {
        var response=await api["register/update"]({communicationlanguage:comlanguage.value,skillslevel:skill,description:description.value,github:github.value,linkedin:linkedin.value,work:work.value,registrationstatus:"completed"});
        if (response.code==200)
        {
